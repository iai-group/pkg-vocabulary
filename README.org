...
pkg:PKGVocabulary a owl:Ontology ;
    ...
    pkg:readAccessBy "MovieBot", "imdb" ;
    pkg:writeAccessBy "MovieBot"
...
pkg:StatementShape a sh:NodeShape ;
  ...
  sh:property
    ...
    [ sh:path pkg:readAccessBy ; sh:minCount 0 ;
	sh:name "Read access by" ; sh:order 4.1 ;
	sh:description "Who has read access to the statement?" ] ,

    [ sh:path pkg:writeAccessBy ; sh:minCount 0 ;
	sh:name "Write access by" ; sh:order 4.2 ;
